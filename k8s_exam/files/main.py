...
mysql_url = 'mysql-service.default.svc.cluster.local' # Replace with the correct MySQL IP address
mysql_user = 'root'
mysql_password = os.getenv('MYSQL_PASSWORD')  # retrieve password from environment variable
database_name = 'Main'
